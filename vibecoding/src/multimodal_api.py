...
_deliverable_dir = os.path.dirname(_this_dir)  # deliverable/
_project_root = os.path.dirname(_deliverable_dir)  # Project/
sys.path.insert(0, _project_root)
sys.path.insert(0, _this_dir)  # for peer imports (numpy_vector_store)
...
class MultimodalAPI:
    ...
    def _get_ltr_model(self):
        ...
        import torch
        ltr_path = os.path.join(_this_dir, "ltr_model.pt")
    ...
    def _get_classifier(self):
        ...
        import torch
        clf_path = os.path.join(_this_dir, "classifier_model.pt")
