...
def main():
    ...
    _SFT_DIR = Path.cwd() / "data" / "sft"
    parser.add_argument("--train-jsonl", default=str(_SFT_DIR / "sft_train.jsonl"))
    parser.add_argument("--val-jsonl", default=str(_SFT_DIR / "sft_val.jsonl"))
